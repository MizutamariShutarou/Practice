...
public class PlayerController : MonoBehaviour
{
    ...
    public StateMachineBase StateMachine => _stateMachine;
    ...
    //{
    //    _machine.CurrentState = startState;
    //    startState.Enter();

    //    // ステート変化時に実行するアクション。
    //    // 引数に最初のステートを渡す。
    //    //_machine.OnStateChanged?.Invoke(null, startState);
    //}
    ...
    //        return;
    //    }
    //    var previousState = _machine.CurrentState;
    //    _machine.CurrentState.Exit();      // 現在ステートの終了処理。
    //    _machine.CurrentState = nextState; // 現在のステートの変更処理。
